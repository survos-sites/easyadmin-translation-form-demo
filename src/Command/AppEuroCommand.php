...
#[AsCommand('app:euro', 'Import the European Parliment dataset')]
final class AppEuroCommand extends InvokableServiceCommand
{
    use RunsCommands;
    use RunsProcesses;
...
//        https://medium.com/@a.marakhin2077/creating-a-file-download-in-symfony-5-from-remote-url-d2a51b1cf547
        $filename = "data/europarl/europarl.tgz";
        ...
        $finder = (new Finder())->directories()->in($dir . '/txt');
        $locales = [];
