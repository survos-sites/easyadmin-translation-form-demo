...
final class SplitPtcCommand extends Command
{
...
//    }
    ...
    public function __invoke(
        SymfonyStyle     $io,
        #[Argument(description: 'url to compressed europarl data')]
...
//                            }
    ...
    private function download(SymfonyStyle $io, string $url, string $filename)
    {
//        https://medium.com/@a.marakhin2077/creating-a-file-download-in-symfony-5-from-remote-url-d2a51b1cf547
        ...
        $progressBar = new ProgressBar($io->output(), 100);
